...
class Command(BaseCommand):
    help = 'Scrape jobs from LinkedIn'
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(f"Starting LinkedIn scraper for keywords: {keywords}")
        ...
        self.stdout.write(self.style.SUCCESS("Finished scraping LinkedIn")) 